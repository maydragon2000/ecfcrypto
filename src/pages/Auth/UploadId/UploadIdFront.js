...
import { saveIdFrontImage } from "../../../store/actions/auth";
import "./style.css"
...
const UploadIdFront = () => {
    ...
    const sendUploadImage = () => {
        ...
        dispatch(saveIdFrontImage(sendImageData));
        navigate("/UploadIdBack");
    }
    ...
    return(
        <div className="upload_id">
            ...
            <div className="upload_id-inner">
                <h1>Upload the front of your ID</h1>
                <div className="image_wrap">
                    <img className="avatar" onClick={handleClick} alt="not found" src={selectedImage ? URL.createObjectURL(selectedImage) : "/image/idcard/front.jpg"} />
