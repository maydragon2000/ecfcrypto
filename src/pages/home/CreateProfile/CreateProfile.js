            ...
            <div className="create-profile ">
                <div className="create-profile-inner row">
                    <div className="col-6 left">
                        <p className="title">Crypto Trustable Platform</p>
                        ...
                        <div className="link-wrap">
                            <Link to="profile/wallet">Start Trading</Link>
                    ...
                    <div className="col-6 right">
                        <div className="d-flex">
                            <div className="create-profile-item">
                                <div className="create-profile-item-img-wrap"><img alt="" src="image/create-account.svg" /></div>
                                <div className="create-profile-item-text-wrap">
                                    <h5>Create an Account</h5>
                                    <p>Sign up with your username and password in just 1 minute !</p>
                                </div>
                            </div>
                            <div className="create-profile-item">
                                <div className="create-profile-item-img-wrap"><img alt="" src="image/verify-bank-account.svg" /></div>
                                <div className="create-profile-item-text-wrap">
                                    <h5>Bank Account</h5>
                        ...
                        <div className="d-flex" style={{ paddingLeft: "50px" }}>
                            <div className="create-profile-item">
                                <div className="create-profile-item-img-wrap"><img alt="" src="image/add-funds.svg" /></div>
                                <div className="create-profile-item-text-wrap">
                            ...
                            <div className="create-profile-item" style={{ marginRight: "0px" }} >
                                <div className="create-profile-item-img-wrap"><img alt="" src="image/trading-instantly.svg" /></div>
                                <div className="create-profile-item-text-wrap">
